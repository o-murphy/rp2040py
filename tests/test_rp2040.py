...
def test_initializes_pc_and_sp_according_to_bootroms_vector_table():
    rp2040 = RP2040()
...
class TestIoRegisterWrites:
    ...
    def test_replicates_8_bit_values_four_times(self):
        rp2040 = RP2040()
    ...
    def test_replicates_16_bit_values_twice(self):
        rp2040 = RP2040()
        write_uint32 = self._spy_peripheral(rp2040, "TestPeripheral")
        rp2040.write_uint16(0x10123, 0x12345678)
        write_uint32.assert_called_with(0x120, 0x56785678)

    def test_supports_atomic_io_register_write_addresses(self):
        rp2040 = RP2040()
...
class TestExceptionEntryAndReturn:
    def test_executes_an_exception_handler_and_returns_from_it_correctly(self):
        int1 = 1 << 1
    ...
    def test_returns_correctly_from_exception_with_pop_lr(self):
        int1 = 1 << 1
        int1_handler = 0x10000100
        exc_int1 = 16 + 1
        rp2040 = RP2040()
    ...
    def test_clears_the_pending_interrupt_flag_in_exception_entry_for_user_irqs_above_25(self):
        int31 = 1 << 31
...
class TestNvicRegisters:
    def test_writing_to_nvic_ispr_sets_the_corresponding_pending_interrupt_bits(self):
        rp2040 = RP2040()
        rp2040.core.pending_interrupts = 0x1
        rp2040.write_uint32(NVIC_ISPR, 0x10)
        assert rp2040.core.pending_interrupts == 0x11

    def test_writing_to_nvic_icpr_clears_corresponding_pending_interrupt_bits(self):
        rp2040 = RP2040()
    ...
    def test_returns_the_correct_interrupt_priorities_when_reading_from_nvic_ipr5(self):
        rp2040 = RP2040()
