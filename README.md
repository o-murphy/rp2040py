...
12 worked `--board-spec` targets for real third-party hardware live in [boards/](boards/) - every
...
- **A real extension point for third-party hardware** (`ExternalDevice`/`boards.BoardSpec`) -
  ...
  scripts. rp2040py ships 12 worked `--board-spec` examples for real vendor boards (WeAct Studio,
