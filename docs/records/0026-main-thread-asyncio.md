# 0026. Main-thread asyncio (primary Simulator engine room on the process main thread)

- Status: Implemented — all 5 phases landed and verified
- Conceived: 2026-08-12
- Related: 0025 (full asyncio migration)

<!-- migrated verbatim from docs/MAIN_THREAD_ASYNCIO_BACKLOG.md lines 1-480 -->
