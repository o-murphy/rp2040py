...
- [ ] [0089] one reset for every trigger: soft vs hard, guest- vs host-initiated | **Phases 0-2, 4 and 5 landed, Phase 3 dropped as unwanted, Phase 6 not started** (2026-08-20); the umbrella record for reset across [0057]/[0087]/[0088]
