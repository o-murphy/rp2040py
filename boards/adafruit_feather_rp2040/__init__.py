...
with e.g.:
    ...
    rp2040py micropython --board-spec boards/adafruit_feather_rp2040/__init__.py:BOARD -c "<probe>"
    rp2040py micropython --circuitpython --board-spec boards/adafruit_feather_rp2040/__init__.py:BOARD -c "<probe>"
...
Directory named `adafruit_feather_rp2040` after both firmwares' own board id - MicroPython's
