...
- Not modelled: any **RESET/BOOT pushbutton** beyond BOOTSEL. CircuitPython's `pins.c` declares no
  ...
  is claimed about this board's physical controls. Also not modelled: the USB-A plug, and the RP2040's own RTC
  (not board-specific).
"""
...
FIRMWARE = {
    "circuitpython": BoardFirmwareSpec(
        ...
        fw={
            ...
            "10.3.0-rc.0": "https://adafruit-circuit-python.s3.amazonaws.com/bin/waveshare_rp2040_one/en_US/adafruit-circuitpython-waveshare_rp2040_one-en_US-10.3.0-rc.0.uf2",
            "10.3.0": "https://adafruit-circuit-python.s3.amazonaws.com/bin/waveshare_rp2040_one/en_US/adafruit-circuitpython-waveshare_rp2040_one-en_US-10.3.0.uf2",
            "10.3.1": "https://adafruit-circuit-python.s3.amazonaws.com/bin/waveshare_rp2040_one/en_US/adafruit-circuitpython-waveshare_rp2040_one-en_US-10.3.1.uf2",
        },
